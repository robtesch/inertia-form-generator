...
class InertiaFormGeneratorCommand extends Command
{
    ...
    /**
     * @param  list<array{formName: string, initial: string}>  $transformed
     */
    private function exportToFile(array $transformed): void
    {
        ...
        $fileContents = '// This file is auto-generated by the inertia-form-generator package'.PHP_EOL.PHP_EOL;
        ...
        foreach ($transformed as $transformedRequest) {
            $fileContents .= 'export const '.$transformedRequest['formName'].' = useForm('.$transformedRequest['initial'].');'.PHP_EOL.PHP_EOL;
        }
